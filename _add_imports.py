...
MODULE_IMPORTS = {
    ...
    'tools_core.py': '\n'.join([
        ...
        'from orca_code.security import _DANGEROUS_PATTERNS',
    ]),
    'tools_office.py': '\n'.join([
        'import os, sys, json, time, logging, threading',
        'from pathlib import Path',
        'from orca_code.config import (CONFIG, TEMP_DIR, ensure_pkg, console)',
    ...
    'tools_web.py': '\n'.join([
        ...
        'from orca_code.security import _is_safe_url',
    ]),
    'tools_dev.py': '\n'.join([
